...
namespace CircleSharp
{
	...
	{
		internal bool[,] RaceClassMatrix = new bool[4, 4] { { true, true, true, true }, { true, true, true, true }, { true, true, true, true }, { true, true, true, true } };
		internal bool[,] RaceGenderMatrix = new bool[3, 4] { { true, true, true, true }, { true, true, true, true }, { false, false, false, false } };
